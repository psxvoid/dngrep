...
{
    public class MethodBodyParentSyntaxNodeMatcherTests : SyntaxNodeMatcherTestBase
    {
        protected override ISyntaxNodeMatcher Sut => MethodBodyParentSyntaxNodeMatcher.Instance;
        ...
        [Fact]
        public void Match_MethodDeclaration_True()
        {
            const string sourceText = "class C { int GetX() { return 0; } }";

            this.AssertMatch<MethodDeclarationSyntax>(sourceText, true);
        }

        [Fact]
        public void Match_MethodDeclarationBlockBody_False()
        {
            const string sourceText = "class C { int GetX() { return 0; } }";

            this.AssertMatch<MethodDeclarationSyntax>(sourceText, false, x => x.Body.NotNull());
        }
        
        [Fact]
        public void Match_ConstructorDeclaration_True()
        {
            const string sourceText = "class C { C() { } }";

            this.AssertMatch<ConstructorDeclarationSyntax>(sourceText, true);
        }

        [Fact]
        public void Match_ConstructorDeclarationBlockBody_False()
        {
            const string sourceText = "class C { C() { } }";
        ...
        [Fact]
        public void Match_ConstructorDeclarationExpressionBody_False()
        {
        ...
        [Fact]
        public void Match_DestructorDeclaration_True()
        {
            const string sourceText = "class C { ~C() { } }";

            this.AssertMatch<DestructorDeclarationSyntax>(sourceText, true);
        }

        [Fact]
        public void Match_DestructorDeclarationBlockBody_False()
        {
            const string sourceText = "class C { ~C() { } }";
        ...
        [Fact]
        public void Match_DestructorDeclarationExpressionBody_False()
        {
            const string sourceText = "class C { ~C() => System.Write(5); }";
        ...
        [Fact]
        public void Match_LocalFunction_True()
        {
        ...
        [Fact]
        public void Match_LocalFunctionBlockBody_False()
        {
            const string sourceText = "class C { void M() { int F() { return 0; } } }";
        ...
        [Fact]
        public void Match_MethodDeclarationExpressionBody_False()
        {
